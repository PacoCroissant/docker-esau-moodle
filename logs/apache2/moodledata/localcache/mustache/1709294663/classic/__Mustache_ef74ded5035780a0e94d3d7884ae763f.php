...
class __Mustache_ef74ded5035780a0e94d3d7884ae763f extends Mustache_Template
{
...
';
        $value = $context->findDot('output.has_communication_links');
        $buffer .= $this->sectionD141ba5deb4fb2ce562e98274ce5ba13($context, $indent, $value);
...
';
    ...
    private function sectionD141ba5deb4fb2ce562e98274ce5ba13(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <div class="footer-section footer-link-communication">
';
